...
class PBIXRay:
    ...
    @property
    def attribute_hierarchies(self):
    ...
    @property
    def detail_rows_definitions(self):
        return self._metadata_handler.metadata.detail_rows_definitions_df

    @property
    def format_string_definitions(self):
    ...
    @property
    def related_column_details(self):
